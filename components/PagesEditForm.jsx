...
export default class PagesEditForm extends React.Component {
    ...
    render() {
        ...
        var imagePath = '';
        if (image) {
            imagePath = `https://${gcpStorageBucket}.storage.googleapis.com${image}`;
        ...
        return (
            <div>
                ...
                <div className="callout secondary">
                    ...
                    <p>You will be prompted for a URL, (enter the full image file name, e.g. "https://{gcpStorageBucket}.storage.googleapis.com/basics/News-Generic2_169.jpg", which you can copy above,) and a Description, (enter a comment, e.g. "Daggers TBS Stand".)</p>
