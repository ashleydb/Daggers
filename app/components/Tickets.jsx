                ...
                <div className="row">
                    ...
                    <h3>Ticket Options</h3>
                        <ul>
                            ...
                            <li>Traditional Builders Stand: Seated (Away fans permitted)</li>
                        </ul>
                        ...
                        <p>To purchase your season ticket please download an application form and send to the club, or alternatively, pop into the club shop (opening times) and fill in an application.</p>
                        <p>REMINDER | If you can’t make it during club shop opening hours you can post your form to the club. Alternately drop it off at the Daggers Bar if the club shop is closed and it will be processed the next day.</p>
                        <ul>
                            <li>Family stand half year season tickets will only be issued with minimum of one adult/concession and one junior/under-10 per application.</li>
                            <li>Concessions are over 65s and students with a valid NUS card.</li>
