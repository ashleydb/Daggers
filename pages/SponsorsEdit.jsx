...
import SponsorsEditForm from '../components/SponsorsEditForm';
    ...
    render() {
        ...
        if (status.isFetching) {
            ...
            var contentRows = sponsors.map((sponsor) => {
                return (
                    <tr key={sponsor.id}>
                        <td><Link href={`/admin/sponsors/${sponsor.id}`}>{sponsor.name}</Link></td>
                        <td><Link href={`/admin/sponsors/${sponsor.id}`} className="button"><i className="fi-pencil"></i> Edit</Link></td>
            ...
            return (
                <div>
                    {errorMessage}
                    <Link href={`/admin/sponsors/new`} className="button expanded"><i className="fi-plus"></i> Create New</Link>
            ...
            return (
                <div>
                    <div className="callout alert">
                        ...
                        <Link href={`/admin/sponsors/new`}><i className="fi-plus"></i> Create New</Link>
                    </div>
                </div>
            );
        }
