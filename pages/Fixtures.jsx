        ...
        if (status.isFetching) {
            ...
            fixtures.forEach((fixture) => {
                if (fixture.season == season && (squad == 'All' || squad == fixture.squad)) {
                    var logo = fixture.logo ?   `https://${gcpStorageBucket}.storage.googleapis.com${fixture.logo}` :    // `/images/uploads/teams/${fixture.logo}` :
                                                `https://${gcpStorageBucket}.storage.googleapis.com/basics/clublogo.png`;// '/images/clublogo.png';
                ...
                <div>
                    ...
                    <div className="row">
                        <div className="columns small-12 large-8">
                            ...
                            <Link href={'/fixturescalendar'} className="expanded button"><i className="fi-calendar"></i> Add Daggers Fixtures to your Calendar</Link>
