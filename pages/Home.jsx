...
import PitcheroVideoPlayer from '../components/PitcheroVideoPlayer';
                ...
                <div>
                    ...
                    <div className="row hide-for-large">
                        <a href="http://www.vanarama.co.uk/">
                            <img src={`https://${gcpStorageBucket}.storage.googleapis.com/basics/league-sponsor.png`} className="league-sponsor float-center" alt="Vanarama"/>
                        </a>
                    </div>
